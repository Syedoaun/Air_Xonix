...
textcol db 0
	...
	str8 db "1. Use left arraw '<' , right arrow '>', up '^', and down '_' key(s) to move the spaceship around $"
    ...
    count db 0             ; counter for the number of digitsle
...
losepage:
	...
	; open file write to file    username
		lea dx, filename            ; Load address of String “file”
		mov al, 2                   ; Open file (read/write)
		mov ah, 3ch                 ; Load File Handler and store in ax
		int 21h
	...
	; open file write to file   highscore
		lea dx, filename            ; Load address of String “file”
		mov al, 2                   ; Open file (read/write)
		mov ah, 3ch                 ; Load File Handler and store in ax
		int 21h
		mov cx, LENGTHOF buffer    ; Number of bytes to write
		mov bx, ax                  ; Move file Handler to bx
